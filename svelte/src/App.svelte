	...
	const getData = async () => {
		if (vscode)
			...
			setDataString(
				...
				// `{"name":"aggr","interfaces":[],"types":[],"services":[[{"name":"S3","execution":"single","file":"\/svcs.ol","id":0,"ranges":[{"name":"svc_name","range":{"start":{"line":7,"char":8},"end":{"line":7,"char":10}}}]},{"name":"S2","execution":"single","file":"\/svcs.ol","id":1,"ranges":[{"name":"svc_name","range":{"start":{"line":4,"char":8},"end":{"line":4,"char":10}}}]},{"name":"S1","execution":"single","file":"\/svcs.ol","id":2,"ranges":[{"name":"svc_name","range":{"start":{"line":1,"char":8},"end":{"line":1,"char":10}}}]}]]}`
				`{"name":"api_gateway","interfaces":[{"name":"GenericInterface","file":"\/gateway.ol","id":0,"oneway":[{"name":"op","req":"void"}]}],"types":[],"services":[[{"embeddings":[{"execution":"single","file":"\/gateway.ol","parentPort":"test","ranges":[{"name":"svc_name","range":{"start":{"line":29,"char":8},"end":{"line":29,"char":12}}}],"name":"test","id":1}],"execution":"concurrent","file":"\/gateway.ol","ranges":[{"name":"svc_name","range":{"start":{"line":4,"char":8},"end":{"line":4,"char":30}}},{"name":"embed_test","range":{"start":{"line":19,"char":10},"end":{"line":20,"char":-1}}}],"outputPorts":[{"name":"serverOP","protocol":"sodep","interfaces":[{"name":"GenericInterface","id":0}],"location":"socket:\/\/localhost:9000","ranges":[{"name":"protocol","range":{"start":{"line":10,"char":-6},"end":{"line":10,"char":-1}}},{"name":"location","range":{"start":{"line":9,"char":-26},"end":{"line":9,"char":-1}}},{"name":"port","range":{"start":{"line":7,"char":15},"end":{"line":12,"char":-1}}}]},{"name":"server2OP","protocol":"sodep","location":"socket:\/\/localhost:9010","ranges":[{"name":"protocol","range":{"start":{"line":16,"char":-6},"end":{"line":16,"char":-1}}},{"name":"location","range":{"start":{"line":15,"char":-26},"end":{"line":15,"char":-1}}},{"name":"port","range":{"start":{"line":13,"char":15},"end":{"line":18,"char":-1}}}],"oneway":[{"name":"dummy","req":"void"}]},{"name":"test","protocol":"sodep","location":"local","ranges":[{"name":"port","range":{"start":{"line":19,"char":10},"end":{"line":20,"char":-1}}}]}],"name":"GatewayTestingLongName","inputPorts":[{"annotation":"aggregator","protocol":"http","ranges":[{"name":"protocol","range":{"start":{"line":25,"char":-5},"end":{"line":25,"char":-1}}},{"name":"location","range":{"start":{"line":24,"char":-26},"end":{"line":24,"char":-1}}},{"name":"port","range":{"start":{"line":22,"char":14},"end":{"line":27,"char":-1}}}],"name":"ApiGateway","location":"socket:\/\/localhost:9988","aggregates":[{"name":"server2OP"},{"name":"serverOP"}]}],"id":0}]]}`
			);
