	...
	const getData = async () => {
		if (vscode)
			...
			setDataString(
				...
				`{"name":"dependency","interfaces":[{"name":"localInterface","file":"\/s1.ol","id":0,"oneway":[{"name":"hi","req":"choiceType"}]}],"types":[{"name":"TestType","subTypes":[{"name":"message","file":"\/types\/types.ol","type":"string"}],"file":"\/types\/types.ol"},{"name":"OneType","subTypes":[{"name":"ToRuleThemAll","file":"\/types\/typetwo.ol","type":"string"}],"file":"\/types\/typetwo.ol"},{"name":"choiceType","file":"\/s1.ol","leftType":"TestType","rightType":"OneType"}],"services":[[{"execution":"single","file":"\/s1.ol","ranges":[{"name":"svc_name","range":{"start":{"line":15,"char":8},"end":{"line":15,"char":10}}}],"name":"S1","inputPorts":[{"name":"IP","protocol":"sodep","interfaces":[{"name":"localInterface","id":0}],"location":"socket:\/\/localhost:9000","ranges":[{"name":"protocol","range":{"start":{"line":28,"char":-6},"end":{"line":28,"char":-1}}},{"name":"location","range":{"start":{"line":27,"char":-26},"end":{"line":27,"char":-1}}},{"name":"port","range":{"start":{"line":25,"char":14},"end":{"line":30,"char":-1}}}]}],"id":0}]]}`
			);
